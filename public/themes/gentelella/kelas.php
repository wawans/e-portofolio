    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel" style="height:100%;">
                <div class="x_title">
                    <h2><i class="fa fa-graduation-cap"></i> Kelas Saya</h2>
                            ...
                            <div class="col-md-3 col-xs-12 widget widget_tally_box baru">
                                <div class="x_panel fixed_height_300">
                                    <div class="x_content">
                                        ...
                                        <h3 class="name"><i class="fa fa-plus-circle"></i> Kelas Baru</h3>
                                        ...
                                        <h3 class="pilih">
                                            <a href="#" id="<?=($profile->act==1)?'ikut':'buat';?>-kelas-baru" data-toggle="modal" data-target=".kelas-<?=($profile->act==1)?'ikut':'baru';?>-modal" class="btn btn-danger" style="width: 100%"><?=($profile->act==1)?"IKUT":"BUAT";?></a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
